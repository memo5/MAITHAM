do
--تم التعريب من قبل -Mustafa ip -- @HackeD_o
...
local function list_all_plugins(only_enabled)
  ...
  local text = text..'\nالموجودات '..nsum..' الملفات المثبته.\n'..nact..' الملفات المفعله و '..nsum-nact..' غير مفعل'
  return text
end
...
local function enable_plugin( plugin_name )
  ...
  if plugin_exists(plugin_name) then
    ...
    return 'الملف '..plugin_name..' الملف غير موجود'
  end
end
...
local function disable_plugin( name, chat )
  ...
  if not plugin_exists(name) then
    return 'الملف '..name..' الملف غير موجود'
  end
  local k = plugin_enabled(name)
  -- Check if plugin is enabled
  if not k then
    return 'الملف '..name..' غير مفعل'
  end
  -- Disable and reload
...
return {
  ...
  --delevoper by mustafa ip @HackeD_o